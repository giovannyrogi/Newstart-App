                ...
                <ScrollView>
                    <View style={{ flex: 1, }}>
                        ...
                        <View style={{ marginHorizontal: 15, marginTop: 5 }}>
                            <Text style={styles.textStyle}>Poor Health adalah tingkatan terendah kedua dari
                            daftar Interpretasi pada gambar dibawah,
                            jika Anda mendapatkan hasil Poor Health berarti tubuh Anda mulai menunjukan
                            gejala-gejala penyakit, mulai kehilangan fungsi tubuh dan membutuhkan perawatan medis.{'\n\n'}
