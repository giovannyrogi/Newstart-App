                    ...
                    <View style={{ flex: 1, }}>
                        <View style={{ flexDirection: 'row', marginTop: 5 }}>
                            ...
                            <View style={{ flex: 1, alignContent: 'center', justifyContent: 'center', }}>
                                <Text style={styles.judulStyle}>Optimum Health</Text>
                            </View>
                        </View>
                        <View style={{ marginHorizontal: 15, marginTop: 5 }}>
                            <Text style={styles.textStyle}>
                                Optimum Health adalah tingkatan tertinggi dari semua Interpretasi yang ada.
                                Optimum health artinya kondisi tubuh dan kesehatan Anda sudah yang terbaik. Fungsi tubuh
                                Anda berfungsi dengan baik, Anda mengerti bagaimana cara menjaga kesehatan dan Anda
...
export default DetailOptimumHealth;
