                    ...
                    <View style={{ flex: 1, }}>
                        <View style={{ flexDirection: 'row', marginTop: 5 }}>
                            ...
                            <View style={{ flex: 1, alignContent: 'center', justifyContent: 'center', }}>
                                <Text style={styles.judulStyle}>Good Health</Text>
                            </View>
                        </View>
                        <View style={{ marginHorizontal: 15, marginTop: 5 }}>
                            <Text style={styles.textStyle}>
                                Good Health adalah kondisi tubuh dan kesehatan yang baik, dimana Anda
                                mengerti bagaimana cara menjaga kesehatan dengan melakukan olahraga rutin dan
                                mengkonsumsi nutrisi yang baik untuk tubuh Anda.{'\n\n'}
...
export default DetailGoodHealth;
