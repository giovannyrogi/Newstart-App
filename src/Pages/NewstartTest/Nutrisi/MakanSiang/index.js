...
class MakanPagi extends Component {
    constructor(props) {
        super(props);
        this.state = {
            modalMakanSiang: false,
            show: true,
            dataMakananPokok: dataMakananPokok,
            selectedFoodMakanSiang: [],
            selectedCaloriesMakanSiang: [],
            totalCaloriesMakanSiang: '',
        };
    }

    showOrHideshowModalMakanSiang = () => {
        this.setState({ modalMakanSiang: !this.state.modalMakanSiang })
    }
    ...
    renderMakanSiang = () => {
        if (this.state.selectedFoodMakanSiang && this.state.selectedCaloriesMakanSiang != '') {
            return (
                <View style={{ backgroundColor: '#DEDDDD' }}>
                    ...
                    <View style={{ borderTopWidth: 1, flexDirection: 'row' }}>
                        ...
                        <Text style={{ flex: 1.4, textAlign: 'center', fontFamily: 'Poppins-Bold', paddingVertical: 5 }}>{this.state.totalCaloriesMakanSiang}</Text>
                    </View>
                </View>
    ...
    getSelectedData = () => {
        ...
        this.state.selectedFoodMakanSiang = SelectedMakanan2
        this.state.selectedCaloriesMakanSiang = SelectedCalori2
        this.state.totalCaloriesMakanSiang = hasilKalori
        this.setState({ modalMakanSiang: !this.state.modalMakanSiang })
    }
    renderData = () => {
            ...
            <SafeAreaView>
                ...
                <View style={styles.makananContainer}>
                    <TouchableOpacity
                        ...
                        onPress={this.showOrHideshowModalMakanSiang}
                    >
                        <IconPlus
                ...
                <ModalMakanPagi
                    ...
                    isVisible={this.state.modalMakanSiang}
                    hasBackdrop={true}
                    onBackdropPress={this.showOrHideshowModalMakanSiang}
                        ...
                        <ScrollView>
                            <View style={styles.subModalContainer}>
                                <View style={styles.subContainerMakananPokokStyle}>
                                    <TouchableOpacity onPress={this.showOrHideshowModalMakanSiang} >
                                        <BackArrow
                                            name='arrow-back-ios'
                                            size={25}
